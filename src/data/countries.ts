// Country codes with phone dial codes (sorted alphabetically)
export const countryCodes = [
  ...
  { code: "CG", name: "Congo, Rep.", dial: "+242" },
  { code: "CD", name: "Congo, Dem. Rep.", dial: "+243" },
  ...
  { code: "EG", name: "Egypt, Arab Rep.", dial: "+20" },
  ...
  { code: "KG", name: "Kyrgyz Republic", dial: "+996" },
  ...
  { code: "FM", name: "Micronesia, Fed. Sts.", dial: "+691" },
  ...
  { code: "PS", name: "Palestine (West Bank and Gaza)", dial: "+970" },
...
export const countryNames = countryCodes.map(c => c.name).sort();

// LMIC Countries List (World Bank 2025 Fiscal Year)
// Lower Middle-Income Countries as per World Bank classification
export const lmicCountries = [
  "Angola",
  "Bangladesh",
  "Benin",
  "Bhutan",
...
// Helper function to check if a country is LMIC
export const isLMICCountry = (countryName: string): boolean => {
  return lmicCountries.includes(countryName);
};

// Helper function to check if a country is India
export const isIndiaCountry = (countryName: string): boolean => {
